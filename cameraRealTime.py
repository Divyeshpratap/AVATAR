...
class POCTrackGenerator:
    ...
    def capture_audio(self, stream, frames_per_clip, audio_rate):
        """
    ...
    def capture_video(self, cap, frames_per_clip):
        """
    ...
    def capture_audio_wrapper(self, stream, frames_per_clip, audio_rate, output_queue):
        audio_data = self.capture_audio(stream, frames_per_clip, audio_rate)
        output_queue.put(audio_data)

    def capture_video_wrapper(self, cap, frames_per_clip, output_queue):
        frames = self.capture_video(cap, frames_per_clip)
    ...
    def run(self):
        ...
        while not self.processing_done:
            ...
            video_thread = threading.Thread(
                ...
                args=(self.cap, self.batch_size, video_queue)
            )
